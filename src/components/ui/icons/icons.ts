export const Icons = {
  ...
  house: {
    ...
    class:
      "h-6 w-6 flex-shrink-0 text-grayText hs-tab-active:text-orange-400 dark:text-neutral-300 dark:hs-tab-active:text-orange-300 md:h-7 md:w-7",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
  ...
  facebook: {
    ...
    class: "size-4 flex-shrink-0 fill-orange",
    viewBox: "0 0 24 24",
    stroke: "currentColor",
  },
  x: {
